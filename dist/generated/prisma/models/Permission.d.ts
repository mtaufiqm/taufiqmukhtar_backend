...
export type PermissionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"description", ExtArgs["result"]["permission"]>;
...
export interface PermissionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
     *
     * // Update zero or more Permissions and only return the `description`
     * const permissionWithDescriptionOnly = await prisma.permission.updateManyAndReturn({
     *   select: { description: true },
     *   where: {
     *     // ... provide filter here
     *   },
